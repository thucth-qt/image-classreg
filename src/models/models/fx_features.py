...
# NOTE: By default, any modules from src.models.models.layers that we want to treat as leaf modules go here
# BUT modules from src.models.models should use the registration mechanism below
_leaf_modules = {
