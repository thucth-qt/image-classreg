...
group.add_argument('--train-ds', '-tds', metavar='NAME', default='',
                help='dataset for training')
group.add_argument('--val-ds', '-vds', metavar='NAME', default='',
                   help='dataset for validation')         

# Model parameters
group = parser.add_argument_group('Model parameters')
group.add_argument('--model', default='efficientnet_b0', type=str, metavar='MODEL',
                help='Name of model to train (default: "resnet50"')
group.add_argument('--pretrained', action='store_true', default=False,
                help='Start with pretrained version of specified network (if avail)')
group.add_argument('--checkpoint-path', default='', type=str, metavar='PATH',
...
group.add_argument('--loss', type=str, default='mse',
                   help='mse or categoricalcrossentropy,...')
